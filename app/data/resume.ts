...
export const experience: Experience[] = [
  {
    ...
    description: `RocketCMS lets anyone manage your website using the components you've designed.`,
    highlights: [
  ...
  },
  {
    ...
    description: `Nearly a year in, and we've accomplished so much. Here are a few milestones worth mentioning.`,
    highlights: [
      `Delivered a full rebuild & rebrand of the Python + Django website to NextJS`,
      `Migrated to a (nearly) fully containerized stack and development workflow`,
      `Introduced GraphQL and strong (generated) types across services`,
  ...
  },
  {
    ...
    description: `Successfully pitched, prototyped, and delivered several high-impact projects within the organization. Assisting in hiring, managing, and mentoring of engineers at various levels, distributed across the globe.`,
    highlights: [
  ...
  },
  {
    ...
    description: `Maintain and expand design system and its components with a strong emphasis on color system and data visualization. Collaborate with broader product, design, and engineering teams to help establish a stronger UX patterns, and solutions. Focus areas include:`,
    highlights: [
  ...
  },
  {
    ...
    description: `
      <p>While at Creative Lift we developed a variety of Mobile & Desktop applications for Facebook, Snapfish, Union Bank, AOL, Gerber, Proactive, Charter and a variety of others.</p>
